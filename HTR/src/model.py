...
class Model:
    ...
    def setup_ctc(self) -> None:
        ...
        # word beam search decoding (see https://github.com/githubharald/CTCWordBeamSearch)
            ...
            word_chars = open("C://Users//SHANVI//Desktop//HTR//model//charList.txt").read().splitlines()[0]
            corpus = open("C://Users//SHANVI//Desktop//HTR//data//corpus.txt").read()
    ...
    def setup_tf(self) -> Tuple[tf.compat.v1.Session, tf.compat.v1.train.Saver]:
        ...
        model_dir = "C://Users//SHANVI//Desktop//HTR//model"
    ...
    def save(self) -> None:
        """Save model to file."""
        self.snap_ID += 1
        self.saver.save(self.sess, 'C://Users//SHANVI//Desktop//HTR//model//snapshot', global_step=self.snap_ID)
